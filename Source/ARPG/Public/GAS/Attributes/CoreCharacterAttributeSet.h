...
public:
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_SpiritRegenPerSecond, Category = "Attributes|Regen")
	FGameplayAttributeData SpiritRegenPerSecond;
	ATTRIBUTE_ACCESSORS(UCoreCharacterAttributeSet, SpiritRegenPerSecond)
...
protected:
	...
	UFUNCTION()
	void OnRep_SpiritRegenRate(const FGameplayAttributeData& OldValue);
};