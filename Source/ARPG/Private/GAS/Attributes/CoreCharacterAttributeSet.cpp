...
void UCoreCharacterAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_CONDITION_NOTIFY(UCoreCharacterAttributeSet, HealthRegenRate, COND_None, REPNOTIFY_Always);
	DOREPLIFETIME_CONDITION_NOTIFY(UCoreCharacterAttributeSet, StaminaRegenRate, COND_None, REPNOTIFY_Always);
	DOREPLIFETIME_CONDITION_NOTIFY(UCoreCharacterAttributeSet, SpiritRegenRate, COND_None, REPNOTIFY_Always);
}
...
void UCoreCharacterAttributeSet::OnRep_HealthRegenRate(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UCoreCharacterAttributeSet, HealthRegenRate, OldValue);
}

void UCoreCharacterAttributeSet::OnRep_StaminaRegenRate(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UCoreCharacterAttributeSet, StaminaRegenRate, OldValue);
}

void UCoreCharacterAttributeSet::OnRep_SpiritRegenRate(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UCoreCharacterAttributeSet, SpiritRegenRate, OldValue);
}